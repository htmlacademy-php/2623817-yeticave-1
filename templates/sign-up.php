<form class="form container <?= ($formError) ? 'form--invalid' : ''?>" action="sign-up.php" method="post" autocomplete="off"> <!-- form
    --invalid -->
      ...
      <div class="form__item <?= $errors['email']['IsError'] ?? false ? 'form__item--invalid' : '' ?>"> <!-- form__item--invalid -->
        ...
        <span class="form__error"><?= $errors['email']['IsError'] ?? false ? $errors['email']['errorDescription'] ?? 'Ошибка' : 'Введите e-mail'?></span>
      </div>
      <div class="form__item <?= $errors['password']['IsError'] ?? false ? 'form__item--invalid' : '' ?>">
        ...
        <span class="form__error"><?= $errors['password']['IsError'] ?? false ? $errors['password']['errorDescription'] ?? 'Ошибка' : 'Введите пароль' ?></span>
      </div>
      <div class="form__item <?= $errors['name']['IsError'] ?? false ? 'form__item--invalid' : '' ?>">
        ...
        <span class="form__error"><?= $errors['name']['IsError'] ?? false ? $errors['name']['errorDescription'] ?? 'Ошибка' : 'Введите имя' ?></span>
      </div>
      <div class="form__item <?= $errors['message']['IsError'] ?? false ? 'form__item--invalid' : '' ?>">
        ...
        <span class="form__error"><?= $errors['message']['IsError'] ?? false ? $errors['message']['errorDescription'] ?? 'Ошибка' : 'Напишите как с вами связаться'?></span>
      </div>
